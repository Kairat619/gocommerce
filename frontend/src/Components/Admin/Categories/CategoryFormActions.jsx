...
export default function CategoryFormActions({ isEdit, processing, errorCount, onSubmit, onSubmitAndContinue }) {
  return (
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm" role={errorCount > 0 ? "alert" : undefined}>
          {errorCount > 0 ? (
            ...
            <span className="text-gray-500">{isEdit ? "Editing category" : "New category"}</span>
          )}
        </p>
